...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Google.Android.Exoplayer2.Audio.AudioCapabilitiesReceiver+IListenerImplementor, ExoPlayer.Core, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", AudioCapabilitiesReceiver_ListenerImplementor.class, __md_methods);
	}
	...
	public AudioCapabilitiesReceiver_ListenerImplementor () throws java.lang.Throwable
	{
		...
		if (getClass () == AudioCapabilitiesReceiver_ListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Google.Android.Exoplayer2.Audio.AudioCapabilitiesReceiver+IListenerImplementor, ExoPlayer.Core, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
