...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Google.Android.Exoplayer2.UI.ITimeBarOnScrubListenerImplementor, ExoPlayer.UI, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", TimeBar_OnScrubListenerImplementor.class, __md_methods);
	}


	public TimeBar_OnScrubListenerImplementor () throws java.lang.Throwable
	{
		super ();
		if (getClass () == TimeBar_OnScrubListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Google.Android.Exoplayer2.UI.ITimeBarOnScrubListenerImplementor, ExoPlayer.UI, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
