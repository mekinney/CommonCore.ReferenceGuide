...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Google.Android.Exoplayer2.Upstream.Cache.CacheDataSource+IEventListenerImplementor, ExoPlayer.Core, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", CacheDataSource_EventListenerImplementor.class, __md_methods);
	}
	...
	public CacheDataSource_EventListenerImplementor () throws java.lang.Throwable
	{
		...
		if (getClass () == CacheDataSource_EventListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Google.Android.Exoplayer2.Upstream.Cache.CacheDataSource+IEventListenerImplementor, ExoPlayer.Core, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
